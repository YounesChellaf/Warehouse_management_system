...
<script type="text/javascript">
  ...
  function actionFormatter(value, row, index) {
      ...
      return [ '<a href="/residant/edit/'+row['id']+'" data-toggle="tooltip" title="Edit"> <i class="fa fa-pencil"></i> </a> &nbsp;&nbsp;<a href="/residant/destroy/'+row['id']+'" data-toggle="tooltip" title="Delete"><i class="fa fa-times"></i></a>' ];
...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Consulter Residants</li>
  </ol>
</section>
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box-header with-bresidant">
            <h3 class="box-title">Consulter Résidents</h3>
            ...
            <div class="row" style="width:99%;margin-left:5px">
                      <div class="col-xs-12">
                        <table id="table" class="table table-responsive" 
                            ...
                            <thead>
                            <tr>
                                <th data-field="id" data-align="center" data-sortable="true">Residant ID</th>
                                <th data-field="resident_name" data-align="center" data-sortable="true">Nom</th>
                                ...
                                <th data-field="resident_contact" data-align="center" data-sortable="true">Mobile</th>

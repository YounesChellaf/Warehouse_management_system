...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Rapport Achat</li>
  </ol>
</section>
...
<!-- Main content -->
    ...
    <div class="row">
      <div class="col-xs-12">
        <h2 class="page-header">
          <i class="fa fa-shopping-bag"></i> Rapport Achat
    ...
    {{-- <div class="row">
      ...
      <div class="col-xs-6">
        <p class="lead">Methodes Payments:</p>
      ...
      <div class="col-xs-6">
        ...
        <div class="table-responsive">
          <table class="table">
            <tr>
              <th style="width:50%">Total Achats:</th>

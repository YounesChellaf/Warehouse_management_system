                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-12">
                          <div class="form-group">
                            ...
                            <textarea class="form-control" placeholder="" name="customer_address"></textarea>
                          </div>
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <input type="text" name="customer_contact1" class ='form-control' placeholder = '' required="required"/>
                          </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <input type="text" name="customer_contact2" class ='form-control' placeholder = ''/>
                          </div>
                        </div>

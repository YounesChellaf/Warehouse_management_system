...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Editer Fournisseur</li>
  </ol>
</section>
      ...
      <div class="row">
        <div class="col-sm-6 col-sm-offset-3">
          ...
          <div class="box-header with-border">
            <h3 class="box-title">Editer Fournisseur</h3>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="supplier_name" placeholder="nom complet" value="{{ $supplier->supplier_name }}">
                          </div>
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-12">
                          <div class="form-group">
                            ...
                            <textarea class="form-control" placeholder="adresse courante ... " name="supplier_address">{{ $supplier->supplier_address }}</textarea>
                          </div>
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <input type="text" name="supplier_contact1" class ='form-control' placeholder = '' required="required"  value="{{ $supplier->supplier_contact1 }}"/>
                          </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <input type="text" name="supplier_contact2" class ='form-control' placeholder = ''  value="{{ $supplier->supplier_contact2 }}"/>
                          </div>
                        </div>
